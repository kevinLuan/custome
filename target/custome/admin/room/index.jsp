...
<link rel="stylesheet" type="text/css" href="/custome/themes/icon.css">
    ...
    <script type="text/javascript" src="/custome/scripts/room/index.js?v=12332"></script>
...
<table align="center">
    ...
    <tr>
	    	<td>人数</td>
	    	<td>
	    		<input id="persionNum" name="persionNum" value="1" maxlength="10" required="true" dataType="Require" msg="*" />
	    	</td>
    </tr>
    <tr>
    		<td>楼层</td>
    		<td>
    			<input id="floor" name="floor" value="1" maxlength="10" required="true" dataType="Require" msg="*" />
    		</td>
    </tr>
    <tr>
    		<td>状态</td>
