...
<link rel="stylesheet" type="text/css" href="/custome/themes/icon.css">
    ...
    <script type="text/javascript" src="/custome/scripts/taocan/index.js?v=12332"></script>
...
<table align="center">
    ...
    <tr>
	    	<td>原价</td>
	    	<td>
	    		<input id="originalPrice" name="originalPrice" value="" maxlength="10" required="true" dataType="Require" msg="*" />
	    	</td>
    </tr>
    <tr>
	    	<td>价格</td>
    ...
    <tr>
	    	<td>包含服务项</td>
	    	<td>
	    		<input id="servicesList" name="servicesList" value="" maxlength="10" required="true" dataType="Require" msg="*" />
	    	</td>
    </tr>
    <tr>
    		<td>状态</td>
