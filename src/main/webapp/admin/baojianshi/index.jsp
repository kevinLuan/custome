...
<link rel="stylesheet" type="text/css" href="/custome/themes/icon.css">
    ...
    <script type="text/javascript" src="/custome/scripts/baojianshi/index.js?v=12332"></script>
...
<table align="center">
    ...
    <tr>
	    	<td>employeNo</td>
	    	<td>
	    		<input id="employeNo" name="employeNo" value="" maxlength="10" required="true" dataType="Require" msg="*" />
	    	</td>
    </tr>
    <tr>
    		<td>状态</td>
