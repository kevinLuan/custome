...
public interface IBaseDao {
  ...
  // 查询返回Map
  @SuppressWarnings("unchecked")
  public Map queryForList(String statementName, Object parameterObject, String keyProperty);

  @SuppressWarnings("unchecked")
  public Map queryForList(String statementName, Object parameterObject, String keyProperty, String valueProperty);
