...
public class BaseController {
   ...
   * @return
   */
  protected com.kevin.role.dao.model.RoleUser getSessionUser(HttpServletRequest request) {
    HttpSession session = request.getSession();
    return (com.kevin.role.dao.model.RoleUser) session.getAttribute("LOGIN_USER");
  }
